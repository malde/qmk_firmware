...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
        ...
        KC_NO,   KC_LALT, KC_LGUI,                   KC_SPC,                             KC_RGUI, KC_RALT,          KC_NO,   KC_NO,   KC_NO
    ),
     ...
     */
        ...
        _______, _______, MO(2),                     _______,                            MO(2),   _______,          _______, _______, _______
    ),
