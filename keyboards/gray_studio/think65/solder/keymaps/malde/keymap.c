...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
        ...
        RGB_TOG, RGB_M_P, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, _______, UUML,    _______, OUML,    _______, _______, _______, _______,
        _______, AUML,    SZ,      RGB_HUD, RGB_SAD, RGB_VAD, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, _______, _______, _______, _______,
     ...
     */
        ...
        _______, _______, _______, RGB_HUD, RGB_SAD, RGB_VAD, _______, _______, _______, _______, _______, _______, _______, RESET,
